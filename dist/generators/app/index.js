...
import { askAddMoreDeps, askBaseProjectInfo, askDependencies, askPackageName, askReuseLastDeps, askUseLastConfig, } from "./prompts.js";
...
export default class extends Generator {
    allowedProjectTypes = ["gradle-project", "gradle-project-kotlin", "maven-project"];
    async prompting() {
        const initializr = await fetchMetadata();
        this.log(chalk.bold(`🌱 ${chalk.hex("#6DB33F")("Spring")} ${chalk.hex("#FFFFFF")("Initializr")} CLI\n`));
        ...
        const allDependenciesFlat = Object.values(initializr.dependencies.values).flatMap((category) => category.values.map((dep) => ({
            name: dep.name,
            value: dep.id,
        })));
